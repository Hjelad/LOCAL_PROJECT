...
package local_project.apriori_automatise_0_1;
...
/**
 * Job: APRIORI_automatise Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class APRIORI_automatise implements TalendJob {
...
public String getCreation_table_candidat(){
	...
	private final String jobName = "APRIORI_automatise";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				APRIORI_automatise.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(APRIORI_automatise.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row13Struct implements routines.system.IPersistableRow<row13Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_APRIORI_automatise = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_APRIORI_automatise) {
...
query_tDBRow_8 = "ALTER TABLE transactions DROP INDEX  IF EXISTS ID,  ADD INDEX ID(ID,Item)";
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_APRIORI_automatise.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_APRIORI_automatise.length == 0) {
   					commonByteArray_LOCAL_PROJECT_APRIORI_automatise = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_APRIORI_automatise = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_APRIORI_automatise, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_APRIORI_automatise, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 final boolean execStat = this.execStat;
	...
	long timetChronometerStop_2;
		...
		timetChronometerStop_2 = System.currentTimeMillis() - startTime;
	  	...
	  	System.out.println("Frequent taille "+context.compteur + "  " + timetChronometerStop_2 + " milliseconds");
 ...
 */
    ...
    public static void main(String[] args){
        final APRIORI_automatise APRIORI_automatiseClass = new APRIORI_automatise();

        int exitCode = APRIORI_automatiseClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = APRIORI_automatise.class.getClassLoader().getResourceAsStream("local_project/apriori_automatise_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = APRIORI_automatise.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : APRIORI_automatise");
        }
...
/************************************************************************************************
 *     197497 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 mai 2019 11:32:33 CEST
 ************************************************************************************************/
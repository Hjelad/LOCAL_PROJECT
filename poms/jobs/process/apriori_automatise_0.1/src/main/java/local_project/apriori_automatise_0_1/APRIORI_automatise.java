...
public class APRIORI_automatise implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(APRIORI_automatise.this, new Object[] { e,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_APRIORI_automatise.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_APRIORI_automatise.length == 0) {
				...
				dis.readFully(commonByteArray_LOCAL_PROJECT_APRIORI_automatise,
						0, length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_APRIORI_automatise, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				while (context.compteur <= context.taille) {
					...
					if (context.compteur > 2) {
						...
						select = select
								+ "t1.item1 AS item1, t2.item1 AS item2";
					}
	...
	public void tChronometerStop_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("Frequent taille " + context.compteur + "  "
						+ timetChronometerStop_2 + " milliseconds");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = APRIORI_automatise.class
					.getClassLoader().getResourceAsStream(
							"local_project/apriori_automatise_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = APRIORI_automatise.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : APRIORI_automatise");
		}
...
/************************************************************************************************
 * 185737 characters generated by Talend Open Studio for Data Integration on the
 * 17 mai 2019 10:25:41 CEST
 ************************************************************************************************/

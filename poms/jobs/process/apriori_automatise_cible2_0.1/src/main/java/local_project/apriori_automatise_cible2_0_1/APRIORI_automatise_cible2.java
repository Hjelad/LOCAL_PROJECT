...
package local_project.apriori_automatise_cible2_0_1;
...
/**
 * Job: APRIORI_automatise_cible2 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class APRIORI_automatise_cible2 implements TalendJob {
...
public String getRequete_frequent(){
	...
	private final String jobName = "APRIORI_automatise_cible2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				APRIORI_automatise_cible2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(APRIORI_automatise_cible2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row13Struct implements routines.system.IPersistableRow<row13Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_APRIORI_automatise_cible2 = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_APRIORI_automatise_cible2) {
...
query_tDBRow_5 = "TRUNCATE TABLE transactions";
...
query_tDBRow_6 = "ALTER TABLE transactions ADD INDEX ID(ID,Item)";
...
query_tDBRow_11 = "DROP TABLE  IF EXISTS transactions_cible";
...
query_tDBRow_12 = "CREATE TABLE transactions_cible (id INT, item INT)";
...
query_tDBRow_1 = "INSERT INTO transactions_cible (\nSELECT t.id, t.item\nFROM transactions AS t, (\nSELECT id\nFROM transactions\nWHERE i"
...
public static class row17Struct implements routines.system.IPersistableRow<row17Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_APRIORI_automatise_cible2.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_APRIORI_automatise_cible2.length == 0) {
   					commonByteArray_LOCAL_PROJECT_APRIORI_automatise_cible2 = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_APRIORI_automatise_cible2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_APRIORI_automatise_cible2, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_APRIORI_automatise_cible2, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
    ...
    public static void main(String[] args){
        final APRIORI_automatise_cible2 APRIORI_automatise_cible2Class = new APRIORI_automatise_cible2();

        int exitCode = APRIORI_automatise_cible2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = APRIORI_automatise_cible2.class.getClassLoader().getResourceAsStream("local_project/apriori_automatise_cible2_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = APRIORI_automatise_cible2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : APRIORI_automatise_cible2");
        }
...
/************************************************************************************************
 *     229563 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 mai 2019 11:32:04 CEST
 ************************************************************************************************/
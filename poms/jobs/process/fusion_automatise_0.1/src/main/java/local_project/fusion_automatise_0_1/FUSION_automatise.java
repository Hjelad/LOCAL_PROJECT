...
public class FUSION_automatise implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (creation_table_frequent != null) {
				...
				this.setProperty("creation_table_frequent",
						creation_table_frequent.toString());

			}

			if (creation_table_candidat != null) {

				this.setProperty("creation_table_candidat",
						creation_table_candidat.toString());
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(FUSION_automatise.this, new Object[] { e,
	...
	public void tChronometerStop_2_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tChronometerStop_2_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_FUSION_automatise.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_FUSION_automatise.length == 0) {
				...
				dis.readFully(commonByteArray_LOCAL_PROJECT_FUSION_automatise,
						0, length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_FUSION_automatise, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		try {
				...
				if (row11 != null) {
					...
					if (row3 != null) {
						...
						if (row6 != null) {
							...
							if (conn_tDBCommit_4 != null
									&& !conn_tDBCommit_4.isClosed()) {
			...
			try {
				...
				if (resourceMap.get("statementClosed_tDBRow_7") == null) {
					...
					if ((stmtToClose_tDBRow_7 = (java.sql.Statement) resourceMap
							.remove("stmt_tDBRow_7")) != null) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (row12.item1 != null) {
							sb_tFileOutputDelimited_2.append(row12.item1);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row12.item2 != null) {
							sb_tFileOutputDelimited_2.append(row12.item2);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row12.item3 != null) {
							sb_tFileOutputDelimited_2.append(row12.item3);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row12.item4 != null) {
							sb_tFileOutputDelimited_2.append(row12.item4);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row12.item5 != null) {
							sb_tFileOutputDelimited_2.append(row12.item5);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row12.item6 != null) {
							sb_tFileOutputDelimited_2.append(row12.item6);
						}
						sb_tFileOutputDelimited_2
	...
	public void tChronometerStop_2Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				start_Hash
						.put("tChronometerStop_2", System.currentTimeMillis());
				...
				System.out.println("A PRIORI Frequent taille "
						+ context.compteur + "  " + timetChronometerStop_2
						+ " milliseconds");

				Long currentTimetChronometerStop_2 = System.currentTimeMillis();
				globalMap.put("tChronometerStop_2",
						currentTimetChronometerStop_2);

				globalMap.put("tChronometerStop_2_STOPTIME",
						currentTimetChronometerStop_2);
				globalMap.put("tChronometerStop_2_DURATION",
						timetChronometerStop_2);
	...
	public void tJava_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				conn_tDBRow_10 = (java.sql.Connection) globalMap
						.get("conn_tDBConnection_1");

				resourceMap.put("conn_tDBRow_10", conn_tDBRow_10);
				java.sql.Statement stmt_tDBRow_10 = conn_tDBRow_10
						.createStatement();
				...
				conn_tDBRow_9 = (java.sql.Connection) globalMap
						.get("conn_tDBConnection_1");

				resourceMap.put("conn_tDBRow_9", conn_tDBRow_9);
				java.sql.Statement stmt_tDBRow_9 = conn_tDBRow_9
						.createStatement();
				...
				if (row14 != null) {
					...
					if (row15 != null) {
						...
						if (row16 != null) {
							...
							if (conn_tDBCommit_5 != null
									&& !conn_tDBCommit_5.isClosed()) {
			...
			try {
				...
				if (resourceMap.get("statementClosed_tDBRow_8") == null) {
					...
					if ((stmtToClose_tDBRow_8 = (java.sql.Statement) resourceMap
							.remove("stmt_tDBRow_8")) != null) {
				...
				if (resourceMap.get("statementClosed_tDBRow_9") == null) {
					...
					if ((stmtToClose_tDBRow_9 = (java.sql.Statement) resourceMap
							.remove("stmt_tDBRow_9")) != null) {
				...
				if (resourceMap.get("statementClosed_tDBRow_10") == null) {
					...
					if ((stmtToClose_tDBRow_10 = (java.sql.Statement) resourceMap
							.remove("stmt_tDBRow_10")) != null) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (row17.item1 != null) {
							sb_tFileOutputDelimited_3.append(row17.item1);
						}
						sb_tFileOutputDelimited_3
								.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row17.item2 != null) {
							sb_tFileOutputDelimited_3.append(row17.item2);
						}
						sb_tFileOutputDelimited_3
								.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row17.item3 != null) {
							sb_tFileOutputDelimited_3.append(row17.item3);
						}
						sb_tFileOutputDelimited_3
								.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row17.item4 != null) {
							sb_tFileOutputDelimited_3.append(row17.item4);
						}
						sb_tFileOutputDelimited_3
								.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row17.item5 != null) {
							sb_tFileOutputDelimited_3.append(row17.item5);
						}
						sb_tFileOutputDelimited_3
								.append(OUT_DELIM_tFileOutputDelimited_3);
						if (row17.item6 != null) {
							sb_tFileOutputDelimited_3.append(row17.item6);
						}
						sb_tFileOutputDelimited_3
	...
	public void tChronometerStop_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("NAIF Frequent taille " + context.compteur
						+ "  " + timetChronometerStop_1 + " milliseconds");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = FUSION_automatise.class
					.getClassLoader().getResourceAsStream(
							"local_project/fusion_automatise_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = FUSION_automatise.class
						.getClassLoader()
						.getResourceAsStream(
			...
			context.creation_table_frequent = (String) context
					.getProperty("creation_table_frequent");
			context.setContextType("creation_table_candidat", "id_String");

			context.creation_table_candidat = (String) context
					.getProperty("creation_table_candidat");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("creation_table_frequent")) {
				context.creation_table_frequent = (String) parentContextMap
						.get("creation_table_frequent");
			}
			if (parentContextMap.containsKey("creation_table_candidat")) {
				context.creation_table_candidat = (String) parentContextMap
						.get("creation_table_candidat");
			}
		}
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : FUSION_automatise");
		}

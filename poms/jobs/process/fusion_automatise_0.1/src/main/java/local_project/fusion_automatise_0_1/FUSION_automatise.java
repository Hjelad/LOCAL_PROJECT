...
package local_project.fusion_automatise_0_1;
...
/**
 * Job: FUSION_automatise Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class FUSION_automatise implements TalendJob {
...
public String getCreation_table_candidat(){
	...
	private final String jobName = "FUSION_automatise";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				FUSION_automatise.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(FUSION_automatise.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row18Struct implements routines.system.IPersistableRow<row18Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_FUSION_automatise = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_FUSION_automatise = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_FUSION_automatise) {
...
query_tDBRow_11 = "ALTER TABLE transactions ADD INDEX ID(ID,Item)";
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_FUSION_automatise.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_FUSION_automatise.length == 0) {
   					commonByteArray_LOCAL_PROJECT_FUSION_automatise = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_FUSION_automatise = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_FUSION_automatise, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_FUSION_automatise, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	NB_ITERATE_tJava_6++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate1", 1, "exec" + NB_ITERATE_tJava_6);
					//Thread.sleep(1000);
				}				
 ...
 */
						if(execStat){
							runStat.updateStatOnConnection("iterate1", 2, "exec" + NB_ITERATE_tJava_6);
						}				
...
query_tDBRow_5 = "DROP TABLE  IF EXISTS item_candidat";
...
query_tDBRow_4 = context.creation_table_candidat;
...
query_tDBRow_3 = context.generation_candidat;
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
        	...
        	row12.support = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	long timetChronometerStop_2;
		...
		timetChronometerStop_2 = System.currentTimeMillis() - startTime;
	  	...
	  	System.out.println("A PRIORI Frequent taille "+context.compteur + "  " + timetChronometerStop_2 + " milliseconds");
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if(rs_tDBInput_3.getObject(1) != null) {
                row17.support = rs_tDBInput_3.getInt(1);
            } else {
                    row17.support = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(2) != null) {
                row17.item1 = rs_tDBInput_3.getInt(2);
            } else {
                    row17.item1 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(3) != null) {
                row17.item2 = rs_tDBInput_3.getInt(3);
            } else {
                    row17.item2 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(4) != null) {
                row17.item3 = rs_tDBInput_3.getInt(4);
            } else {
                    row17.item3 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(5) != null) {
                row17.item4 = rs_tDBInput_3.getInt(5);
            } else {
                    row17.item4 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(6) != null) {
                row17.item5 = rs_tDBInput_3.getInt(6);
            } else {
                    row17.item5 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(7) != null) {
                row17.item6 = rs_tDBInput_3.getInt(7);
            } else {
                    row17.item6 = null;
            }
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	long timetChronometerStop_1;
		...
		timetChronometerStop_1 = System.currentTimeMillis() - startTime;
	  	...
	  	System.out.println("NAIF Frequent taille "+context.compteur + "  " + timetChronometerStop_1 + " milliseconds");
 ...
 */
    ...
    public static void main(String[] args){
        final FUSION_automatise FUSION_automatiseClass = new FUSION_automatise();

        int exitCode = FUSION_automatiseClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = FUSION_automatise.class.getClassLoader().getResourceAsStream("local_project/fusion_automatise_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = FUSION_automatise.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : FUSION_automatise");
        }
...
/************************************************************************************************
 *     256114 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 mai 2019 11:33:27 CEST
 ************************************************************************************************/
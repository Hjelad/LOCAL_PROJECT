...
package local_project.fusion_automatise_cible_0_1;
...
/**
 * Job: FUSION_automatise_cible Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class FUSION_automatise_cible implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(requete_frequent != null){
				
					this.setProperty("requete_frequent", requete_frequent.toString());
...
public String requete_frequent;
public String getRequete_frequent(){
	return this.requete_frequent;
}
	}
	...
	private final String jobName = "FUSION_automatise_cible";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				FUSION_automatise_cible.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(FUSION_automatise_cible.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tDBCommit_6_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tDBCommit_7_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tDBCommit_6_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row18Struct implements routines.system.IPersistableRow<row18Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_FUSION_automatise_cible = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_FUSION_automatise_cible = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_FUSION_automatise_cible) {
...
public void tDBRow_14Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_15 = false;
				conn_tDBRow_15 = (java.sql.Connection)globalMap.get("conn_tDBConnection_1");
 ...
 */
	...
	boolean whetherReject_tDBRow_14 = false;
				conn_tDBRow_14 = (java.sql.Connection)globalMap.get("conn_tDBConnection_1");
...
query_tDBRow_14 = "TRUNCATE TABLE transactions";
...
query_tDBRow_15 = "ALTER TABLE transactions ADD INDEX ID(ID,Item)";
...
int count_tDBOutput_1=0;
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`ID` INT(100)  ,`Item` INT(100)  )");
                                    }
                                }
...
query_tDBRow_1 = "DROP TABLE  IF EXISTS transactions_cible";
...
query_tDBRow_11 = "CREATE TABLE transactions_cible (id INT, item INT)";
...
public void tDBRow_13Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_13 = false;
				conn_tDBRow_13 = (java.sql.Connection)globalMap.get("conn_tDBConnection_1");
...
query_tDBRow_13 = "ALTER TABLE transactions_cible  ADD INDEX ID (id, item) USING BTREE";
...
query_tDBRow_12 = "INSERT INTO transactions_cible (\nSELECT t.id, t.item\nFROM transactions AS t, (\nSELECT id\nFROM transactions\nWHERE i"
+"tem ="+context.cible+"\n) AS filtre\nWHERE t.id = filtre.id \nAND t.item !="+context.cible+")";
...
public void tDBCommit_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 */
	...
	java.sql.Connection conn_tDBCommit_6 = (java.sql.Connection)globalMap.get("conn_tDBConnection_1");
...
if(row5 != null) { 
	...
	java.sql.Connection conn_tDBCommit_7 = (java.sql.Connection)globalMap.get("conn_tDBConnection_1");
...
public static class row17Struct implements routines.system.IPersistableRow<row17Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_FUSION_automatise_cible.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_FUSION_automatise_cible.length == 0) {
   					commonByteArray_LOCAL_PROJECT_FUSION_automatise_cible = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_FUSION_automatise_cible = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_FUSION_automatise_cible, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_FUSION_automatise_cible, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
else {select = select + "t1.item1 AS item1, t2.item1 AS item2";}
...
else { where = where +"t1.item1<t2.item1";}
context.generation_candidat="INSERT INTO item_candidat("+select+from+where+");";
/*System.out.println("Generation candidat niveau : "+context.compteur+" : "+context.generation_candidat);*/


String create = "CREATE TABLE item_candidat (item1 INT";
i=2;
while(i<=context.compteur){
	create=create+", item"+i+" INT";
	i=i+1;
}
create=create+");";
...
query_tDBRow_2 = "DROP TABLE  IF EXISTS item_candidat";
...
query_tDBRow_3 = context.creation_table_candidat;
...
query_tDBRow_7 = context.generation_candidat;
...
while (j<=context.compteur){
	...
	from1 = from1 + ", transactions_cible AS t"+j;
...
j=3;
while (j<=context.compteur){
	where1 = where1 + " AND  t"+(j-1)+".id=t"+j+".id AND  t"+(j-1)+".item<t"+j+".item AND t"+j+".item=c.item"+j;
	j=j+1;
...
query_tDBRow_8 = "DROP TABLE  IF EXISTS item_frequent";
...
query_tDBRow_9 = context.creation_table_frequent;
...
query_tDBRow_10 = context.definition_frequent;
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "SELECT * FROM item_frequent";
            ...
            if(rs_tDBInput_3.getObject(1) != null) {
                row12.support = rs_tDBInput_3.getInt(1);
            } else {
                    row12.support = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(2) != null) {
                row12.item1 = rs_tDBInput_3.getInt(2);
            } else {
                    row12.item1 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(3) != null) {
                row12.item2 = rs_tDBInput_3.getInt(3);
            } else {
                    row12.item2 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(4) != null) {
                row12.item3 = rs_tDBInput_3.getInt(4);
            } else {
                    row12.item3 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(5) != null) {
                row12.item4 = rs_tDBInput_3.getInt(5);
            } else {
                    row12.item4 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(6) != null) {
                row12.item5 = rs_tDBInput_3.getInt(6);
            } else {
                    row12.item5 = null;
            }
		                    }
            ...
            if(rs_tDBInput_3.getObject(7) != null) {
                row12.item6 = rs_tDBInput_3.getInt(7);
            } else {
                    row12.item6 = null;
            }
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	long timetChronometerStop_1;
		...
		timetChronometerStop_1 = System.currentTimeMillis() - startTime;
	  	...
	  	System.out.println("A PRIORI Frequent taille "+context.compteur + "  " + timetChronometerStop_1 + " milliseconds");
...
System.out.println("Nombre de fréquents insérés : " +((Integer)globalMap.get("tDBInput_3_NB_LINE")));
if(((Integer)globalMap.get("tDBInput_3_NB_LINE"))<context.compteur){
...
query_tDBRow_4 = "DROP TABLE  IF EXISTS item_frequent";
...
query_tDBRow_5 = context.creation_table_frequent;
...
query_tDBRow_6 = context.definition_frequent;
...
String fileName_tFileOutputDelimited_3 = "";
    fileName_tFileOutputDelimited_3 = (new java.io.File(context.chemin_sortie)).getAbsolutePath().replace("\\","/");
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if(rs_tDBInput_2.getObject(1) != null) {
                row10.support = rs_tDBInput_2.getInt(1);
            } else {
                    row10.support = null;
            }
		                    }
            ...
            if(rs_tDBInput_2.getObject(2) != null) {
                row10.item1 = rs_tDBInput_2.getInt(2);
            } else {
                    row10.item1 = null;
            }
		                    }
            ...
            if(rs_tDBInput_2.getObject(3) != null) {
                row10.item2 = rs_tDBInput_2.getInt(3);
            } else {
                    row10.item2 = null;
            }
		                    }
            ...
            if(rs_tDBInput_2.getObject(4) != null) {
                row10.item3 = rs_tDBInput_2.getInt(4);
            } else {
                    row10.item3 = null;
            }
		                    }
            ...
            if(rs_tDBInput_2.getObject(5) != null) {
                row10.item4 = rs_tDBInput_2.getInt(5);
            } else {
                    row10.item4 = null;
            }
		                    }
            ...
            if(rs_tDBInput_2.getObject(6) != null) {
                row10.item5 = rs_tDBInput_2.getInt(6);
            } else {
                    row10.item5 = null;
            }
		                    }
            ...
            if(rs_tDBInput_2.getObject(7) != null) {
                row10.item6 = rs_tDBInput_2.getInt(7);
            } else {
                    row10.item6 = null;
            }
		                    }
...
System.out.println("Nombre de fréquents insérés" +((Integer)globalMap.get("tDBInput_2_NB_LINE")));
 ...
 final boolean execStat = this.execStat;
	...
	long timetChronometerStop_2;
		...
		timetChronometerStop_2 = System.currentTimeMillis() - startTime;
	  	...
	  	System.out.println("NAIF Frequent taille "+context.compteur + "  " + timetChronometerStop_2 + " milliseconds");
 ...
 */
    ...
    public static void main(String[] args){
        final FUSION_automatise_cible FUSION_automatise_cibleClass = new FUSION_automatise_cible();

        int exitCode = FUSION_automatise_cibleClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = FUSION_automatise_cible.class.getClassLoader().getResourceAsStream("local_project/fusion_automatise_cible_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = FUSION_automatise_cible.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            if(!context_param.isEmpty()) {
             ...
             try{
                ...
                context.creation_table_candidat=(String) context.getProperty("creation_table_candidat");
				    context.setContextType("requete_frequent", "id_String");
				
                context.requete_frequent=(String) context.getProperty("requete_frequent");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("chemin_entree")) {
            ...
            }if (parentContextMap.containsKey("requete_frequent")) {
                context.requete_frequent = (String) parentContextMap.get("requete_frequent");
            }
        }
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : FUSION_automatise_cible");
        }
...
/************************************************************************************************
 *     284965 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 mai 2019 11:32:57 CEST
 ************************************************************************************************/
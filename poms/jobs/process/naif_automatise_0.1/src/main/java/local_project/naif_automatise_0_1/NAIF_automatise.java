...
public class NAIF_automatise implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(NAIF_automatise.this, new Object[] { e,
	...
	public void tChronometerStop_4_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tChronometerStop_4_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_NAIF_automatise.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_NAIF_automatise.length == 0) {
				...
				dis.readFully(commonByteArray_LOCAL_PROJECT_NAIF_automatise, 0,
						length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_NAIF_automatise, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				while (context.compteur <= context.taille) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("OnComponentOk9", 0,
								"ok");
					}
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("Nombres de fréquent : "
						+ ((Integer) globalMap.get("tDBInput_2_NB_LINE")));
	...
	public void tChronometerStop_4Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				start_Hash
						.put("tChronometerStop_4", System.currentTimeMillis());
				...
				System.out.println("Frequent taille " + context.compteur + "  "
						+ timetChronometerStop_4 + " milliseconds");

				Long currentTimetChronometerStop_4 = System.currentTimeMillis();
				globalMap.put("tChronometerStop_4",
						currentTimetChronometerStop_4);

				globalMap.put("tChronometerStop_4_STOPTIME",
						currentTimetChronometerStop_4);
				globalMap.put("tChronometerStop_4_DURATION",
						timetChronometerStop_4);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = NAIF_automatise.class
					.getClassLoader().getResourceAsStream(
							"local_project/naif_automatise_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = NAIF_automatise.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : NAIF_automatise");
		}
...
/************************************************************************************************
 * 169251 characters generated by Talend Open Studio for Data Integration on the
 * 20 mai 2019 11:09:13 CEST
 ************************************************************************************************/

...
package local_project.naif_automatise_cible2_0_1;
...
/**
 * Job: NAIF_automatise_cible2 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class NAIF_automatise_cible2 implements TalendJob {
...
public String getRequete_frequent(){
	...
	private final String jobName = "NAIF_automatise_cible2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				NAIF_automatise_cible2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(NAIF_automatise_cible2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_NAIF_automatise_cible2 = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_NAIF_automatise_cible2 = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_NAIF_automatise_cible2) {
...
query_tDBRow_3 = "TRUNCATE TABLE transactions";
...
query_tDBRow_7 = "ALTER TABLE transactions ADD INDEX ID(ID,Item)";
...
query_tDBRow_2 = "ALTER TABLE transactions_cible  ADD INDEX ID (id, item) USING BTREE";
...
public static class row17Struct implements routines.system.IPersistableRow<row17Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_NAIF_automatise_cible2.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_NAIF_automatise_cible2.length == 0) {
   					commonByteArray_LOCAL_PROJECT_NAIF_automatise_cible2 = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_NAIF_automatise_cible2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_NAIF_automatise_cible2, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_NAIF_automatise_cible2, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
    ...
    public static void main(String[] args){
        final NAIF_automatise_cible2 NAIF_automatise_cible2Class = new NAIF_automatise_cible2();

        int exitCode = NAIF_automatise_cible2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = NAIF_automatise_cible2.class.getClassLoader().getResourceAsStream("local_project/naif_automatise_cible2_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = NAIF_automatise_cible2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : NAIF_automatise_cible2");
        }
...
/************************************************************************************************
 *     210044 characters generated by Talend Open Studio for Data Integration 
 *     on the 29 mai 2019 11:34:35 CEST
 ************************************************************************************************/
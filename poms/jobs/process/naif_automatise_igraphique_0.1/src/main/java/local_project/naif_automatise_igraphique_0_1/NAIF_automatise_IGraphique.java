...
package local_project.naif_automatise_igraphique_0_1;
...
/**
 * Job: NAIF_automatise_IGraphique Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class NAIF_automatise_IGraphique implements TalendJob {
	...
	private final String jobName = "NAIF_automatise_IGraphique";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					NAIF_automatise_IGraphique.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(NAIF_automatise_IGraphique.this,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_NAIF_automatise_IGraphique = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_NAIF_automatise_IGraphique = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_NAIF_automatise_IGraphique) {
	...
	public static class row7Struct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_NAIF_automatise_IGraphique.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_NAIF_automatise_IGraphique.length == 0) {
						commonByteArray_LOCAL_PROJECT_NAIF_automatise_IGraphique = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_NAIF_automatise_IGraphique = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_LOCAL_PROJECT_NAIF_automatise_IGraphique,
						0, length);
	...
	public static void main(String[] args) {
		final NAIF_automatise_IGraphique NAIF_automatise_IGraphiqueClass = new NAIF_automatise_IGraphique();

		int exitCode = NAIF_automatise_IGraphiqueClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = NAIF_automatise_IGraphique.class
					.getClassLoader().getResourceAsStream(
							"local_project/naif_automatise_igraphique_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = NAIF_automatise_IGraphique.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : NAIF_automatise_IGraphique");
		}
...
/************************************************************************************************
 * 160484 characters generated by Talend Open Studio for Data Integration on the
 * 13 mai 2019 15:11:00 CEST
 ************************************************************************************************/

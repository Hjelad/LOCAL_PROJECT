...
package local_project.test1_automatise_0_1;
 ...
 * @status 
 */
public class test1_automatise implements TalendJob {
	...
	private final String jobName = "test1_automatise";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					test1_automatise.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(test1_automatise.this, new Object[] { e,
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_3 = context.generation_candidat;
	...
	public static void main(String[] args) {
		final test1_automatise test1_automatiseClass = new test1_automatise();

		int exitCode = test1_automatiseClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test1_automatise.class
					.getClassLoader().getResourceAsStream(
							"local_project/test1_automatise_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = test1_automatise.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : test1_automatise");
		}

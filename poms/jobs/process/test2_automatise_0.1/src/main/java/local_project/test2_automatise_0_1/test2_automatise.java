...
package local_project.test2_automatise_0_1;
...
/**
 * Job: test2_automatise Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class test2_automatise implements TalendJob {
	...
	private final String jobName = "test2_automatise";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					test2_automatise.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(test2_automatise.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_test2_automatise = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_test2_automatise = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_test2_automatise) {
	...
	public static class row7Struct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_test2_automatise.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_test2_automatise.length == 0) {
						commonByteArray_LOCAL_PROJECT_test2_automatise = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_test2_automatise = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_test2_automatise,
						0, length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_test2_automatise, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
	...
	public static void main(String[] args) {
		final test2_automatise test2_automatiseClass = new test2_automatise();

		int exitCode = test2_automatiseClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test2_automatise.class
					.getClassLoader().getResourceAsStream(
							"local_project/test2_automatise_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = test2_automatise.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : test2_automatise");
		}
...
/************************************************************************************************
 * 175976 characters generated by Talend Open Studio for Data Integration on the
 * 10 mai 2019 15:31:53 CEST
 ************************************************************************************************/

...
package local_project.test_taile_2_0_1;
...
/**
 * Job: test_taile_2 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class test_taile_2 implements TalendJob {
...
public String getTest_AdditionalParams(){
	...
	private final String jobName = "test_taile_2";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(test_taile_2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
int count_tDBOutput_1=0;
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`ID` INT(1)  ,`Item` INT(1)  )");
                                    }
                                }
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.chemin_entree, "US-ASCII",",","\n",false,1,0,-1,-1, false);
						} catch(java.lang.Exception e) {
...
int count_tDBOutput_2=0;
            ...
            try (java.sql.Statement stmtTrunc_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "item_frequent" + "` (`item`) VALUES (?)";
...
int count_tDBOutput_3=0;
            ...
            try (java.sql.Statement stmtTrunc_tDBOutput_3 = conn_tDBOutput_3.createStatement()) {
				...
				String insert_tDBOutput_3 = "INSERT INTO `" + "item_candidat" + "` (`i1`,`i2`) VALUES (?,?)";
...
} else {pstmt_tDBOutput_3.setInt(1, row4.i1);
}

                            if(row4.i2 == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(2, row4.i2);
}
 ...
 */
    ...
    public static void main(String[] args){
        final test_taile_2 test_taile_2Class = new test_taile_2();

        int exitCode = test_taile_2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = test_taile_2.class.getClassLoader().getResourceAsStream("local_project/test_taile_2_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = test_taile_2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            if(!context_param.isEmpty()) {
                ...
                context.chemin_entree=(String) context.getProperty("chemin_entree");
				    context.setContextType("support", "id_String");
				
                context.support=(String) context.getProperty("support");
				    context.setContextType("taille", "id_String");
				
                context.taille=(String) context.getProperty("taille");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("chemin_entree")) {
                ...
                context.support = (String) parentContextMap.get("support");
            }if (parentContextMap.containsKey("taille")) {
                context.taille = (String) parentContextMap.get("taille");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : test_taile_2");
        }
...
/************************************************************************************************
 *     105458 characters generated by Talend Open Studio for Data Integration 
 *     on the 6 mai 2019 15:41:43 CEST
 ************************************************************************************************/